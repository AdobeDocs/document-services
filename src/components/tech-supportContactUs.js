...
const issue_sub_url_array = [
    {
        ...
        sub_issue_type: "How do I see how many API transactions or calls I've used?",
        sub_issue_type_id: "account-management-how-do-i-see-how-many-api-transactions-or-calls"
    },
    {
        issue_type: "Account Management",
        sub_issue_type: "My company has an existing Enterprise Agreement with Adobe. Can I use the same Adobe credentials for PDF Services API?",
        sub_issue_type_id: "account-management-my-company-has-an-existing-enterprise-agreement-with-adobe-can-i-use-the-same-adobe-credentials"
    },
    {
        issue_type: "Account Management",
        sub_issue_type: "Why do I have to use a personal account when setting up a trial or account? Why can't I use my company's existing enterprise email/account?",
        sub_issue_type_id: "account-management-why-do-i-have-to-use-a-personal-account-when-setting-up-a-trial-or-account"
    },
    {
        issue_type: "Account Management",
        sub_issue_type: "Where do I find my Client ID or API key?",
        sub_issue_type_id: "account-management-where-do-i-find-my-client-id-or-api-key"
    },
    {
        issue_type: "Account Management",
        sub_issue_type: "How do I use my Adobe Document Services credentials in Power Automate, if I initially created them via AWS Marketplace?",
        sub_issue_type_id: "account-management-how-do-i-use-my-adobe-document-services-credentials-in-power-automate"
    },
    {
        issue_type: "Account Management",
        sub_issue_type: "If I already have credentials and need new ones, how do I get them?",
        sub_issue_type_id: "account-management-if-i-already-have-credentials-and-need-new-ones-how-do-i-get-them"
    },
    {
        issue_type: "Account Management",
        sub_issue_type: "Can I continue using my same trial credentials (i.e. keys) when I have paid for Adobe Document Services?",
        sub_issue_type_id: "account-management-can-i-continue-using-my-same-trial-credentials"
    },
    {
        issue_type: "Data Security & Privacy",
        sub_issue_type: "Is Adobe Document Services (PDF Services API and PDF Embed API) HIPAA compliant?",
        sub_issue_type_id: "data-security--privacy-is-adobe-document-services--hipaa-compliant"
    },
    {
        issue_type: "Data Security & Privacy",
        sub_issue_type: "Where are the data centers for Adobe Document Services based?",
        sub_issue_type_id: "data-security--privacy-where-are-the-data-centers-for-adobe-document-services-based"
    },
    {
        issue_type: "Data Security & Privacy",
        sub_issue_type: "Do you have plans to have data centers in EU?",
        sub_issue_type_id: "data-security--privacy-do-you-have-plans-to-have-data-centers-in-eu"
    },
    {
        issue_type: "Data Security & Privacy",
        sub_issue_type: "Does Adobe collect any data about the PDF being viewed or processed? Where are the server side components hosted?",
        sub_issue_type_id: "data-security--privacy-does-adobe-collect-any-data-about-the-pdf-being-viewed-or-processed"
    },
    {
        issue_type: "Data Security & Privacy",
        sub_issue_type: "How are data transfers by Adobe Document Services secured?",
        sub_issue_type_id: "data-security--privacy-how-are-data-transfers-by-adobe-document-services-secured"
    },
    {
        issue_type: "Data Security & Privacy",
        sub_issue_type: "How does Adobe Document Services use or store file content and identity data?",
        sub_issue_type_id: "data-security--privacy-how-does-adobe-document-services-use-or-store-file-content"
    },
    {
        issue_type: "Data Security & Privacy",
        sub_issue_type: "What regulatory compliances are Adobe Document Services certified for?",
        sub_issue_type_id: "data-security--privacy-what-regulatory-compliances-are-adobe-document-services-certified-for"
    },
    {
        issue_type: "Features - PDF Embed API",
        sub_issue_type: "Can I use Adobe Acrobat Sign with PDF Embed API?",
        sub_issue_type_id: "features---pdf-embed-api-can-i-use-adobe-acrobat-sign-with-pdf-embed-api"
    },
    {
        issue_type: "Features - PDF Embed API",
        sub_issue_type: "Can we use PDF Embed API entirely disconnected from the internet?",
        sub_issue_type_id: "features---pdf-embed-api-can-we-use-pdf-embed-api-entirely-disconnected-from-the-internet"
    },
    {
        issue_type: "Features - PDF Embed API",
        sub_issue_type: "Is there any cost to using the PDF Embed API?",
        sub_issue_type_id: "features---pdf-embed-api-is-there-any-cost-to-using-the-pdf-embed-api"
    },
    {
        issue_type: "Features - PDF Embed API",
        sub_issue_type: "How can I set up Adobe Analytics with PDF Embed API?",
        sub_issue_type_id: "features---pdf-embed-api-how-can-i-set-up-adobe-analytics-with-pdf-embed-api"
    },
    {
        issue_type: "Features - PDF Embed API",
        sub_issue_type: "For PDF Embed API, is it possible to map multiple un-related domains to the same client ID? I would like to use the same credentials across all of my domains.",
        sub_issue_type_id: "features---pdf-embed-api-for-pdf-embed-api-is-it-possible-to-map-multiple-un-related-domains-to-the-same-client-id"
    },
    {
        issue_type: "Features - PDF Embed API",
        sub_issue_type: "For PDF Embed API, is it possible to map multiple sub-domains to the same client ID?",
        sub_issue_type_id: "features---pdf-embed-api-for-pdf-embed-api-is-it-possible-to-map-multiple-sub-domains-to-the-same-client-id"
    },
    {
        issue_type: "Features - PDF Embed API",
        sub_issue_type: "For PDF Embed API, I have mapped my domain but later realized the entry was incorrect. How can I update the domain from your portal?",
        sub_issue_type_id: "features---pdf-embed-api-for-pdf-embed-api-i-have-mapped-my-domain-but-later-realized-the-entry-was-incorrect"
    },
    {
        issue_type: "Features - PDF Embed API",
        sub_issue_type: "For PDF Embed API, how many domains can I map to?",
        sub_issue_type_id: "features---pdf-embed-api-for-pdf-embed-api-how-many-domains"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "If I am currently a paid customer, will I have access to the new services in PDF Services API?",
        sub_issue_type_id: "features---pdf-services-api-if-i-am-currently-a-paid-customer-will-i-have-access"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "Can we use the HTML to PDF function without having to zip the HTML files?",
        sub_issue_type_id: "features---pdf-services-api-can-we-use-the-html-to-pdf-function"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "Does PDF services API support custom fonts?",
        sub_issue_type_id: "features---pdf-services-api-does-pdf-services-api-support-custom-fonts"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "Can we create PDFs using HTML in multiple languages?",
        sub_issue_type_id: "features---pdf-services-api-can-we-create-pdfs-using-html"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "How is PDF Services API different from PDF Library? Or from Acrobat DC SDK?",
        sub_issue_type_id: "features---pdf-services-api-how-is-pdf-services-api-different-from-pdf-library"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "What programming languages are supported?",
        sub_issue_type_id: "features---pdf-services-api-what-programming-languages-are-supported"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "Can I run these document services on-premise?",
        sub_issue_type_id: "features---pdf-services-api-can-i-run-these-document-services-on-premise"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "What file formats can I create a PDF?",
        sub_issue_type_id: "features---pdf-services-api-what-file-formats-can-i-create-a-pdf"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "Tracked changes and comment support. What happens to any tracked changes and comments in the DOC or DOCX files that are converted to PDF? Are they rendered in the finalized document, or are tracked changes first accepted/rejected, and are comments removed from the output?",
        sub_issue_type_id: "features---pdf-services-api-tracked-changes-and-comment-support-what-happens-to-any-tracked-changes-and-comments-in-the-doc-or-docx-files"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "Where can we learn more about your Power Automate connector?",
        sub_issue_type_id: "features---pdf-services-api-where-can-we-learn-more-about-your-power-automate-connector"
    },
    {
        issue_type: "Features - PDF Services API",
        sub_issue_type: "Are there usage limitations associted with PDF Services API?",
        sub_issue_type_id: "features---pdf-services-api-are-there-usage-limitations-associted-with-pdf-services-api"
    },
    {
        issue_type: "Support",
        sub_issue_type: "Can we continue to use older versions of the API?",
        sub_issue_type_id: "support-can-we-continue-to-use-older-versions-of-the-api"
    },
    {
        issue_type: "Support",
...
const TechSupportContactUs = ({ }) => {
    ...
    const onChnage = (e) => {
        ...
        if (e.target.id === "issue_type") { setFormValue({ ...formValue, issue_type: e.target.value, issue_sub_type: "" }) }
