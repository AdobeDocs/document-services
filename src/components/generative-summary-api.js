...
const GenerativeSummaryAPI = ({ }) => {
    ...
    return (
        <form className="form-container Generative-Summary-API" id="my_form">
            ...
            <InputField
                ...
                divClassName="area-content-accessibility generative-summary-textBox"
            />
...
GenerativeSummaryAPI.propTypes = {
    theme: PropTypes.string,
    content: PropTypes.string
};

export { GenerativeSummaryAPI };
