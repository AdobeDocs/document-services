...
(async () => {
    ...
    try {
        ...
        readStream = fs.createReadStream("resources/deletePagesInput.pdf");
...
function createOutputFilePath() {
    const filePath = "output/DeletePDFPages/";
    const date = new Date();
    ...
    return (`${filePath}delete${dateString}.pdf`);
}
```
