...
<DCSummaryBlock slots="heading, text, buttons" theme="light" className="We-are-ready-to-help accessibility-summary-one"/>

### Getting started

Interested in the Early Access Program to try out the API?

- [Contact us](../pricing/contact/sales/accessibility)
- [View Documentation](https://developer.adobe.com/document-services/docs/overview/pdf-accessibility-auto-tag-api/)
