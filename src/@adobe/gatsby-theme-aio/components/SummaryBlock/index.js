...
import { layoutColumns, TABLET_SCREEN_WIDTH,MOBILE_SCREEN_WIDTH,DESKTOP_SCREEN_WIDTH } from '@adobe/gatsby-theme-aio/src/utils';
...
const SummaryBlock = ({
  ...
  <section
    ...
    <div
      ...
      {!buttonPositionRight&&(<HeroButtons buttons={buttons} quiets={[false, true]}  />)}
    </div>
    {buttonPositionRight&&(
        <div css={css`
       align-self: flex-end;
